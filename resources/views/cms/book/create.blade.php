                        ...
                        <div class="card card-primary">
                            ...
                            <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                                ...
                                                placeholder="Enter Description of Book" cols="50"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group ">
                                ...
                                <div class="card-footer">
                                    <button type="button" onclick="performStore()" type="button"
    ...
    <script>
        ...
        store('/cms/library/books' , formData);
        }
