        ...
        <div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 bg-light" style="border: 1px solid black;">
                <form class="login100-form validate-form">
                    <span class="login100-form-title p-b-49 text-dark" style="font-size: 33px">
                        Login pages prompt
                    </span>
                    <div class="container-login100-form-btn  mt-3">
                        <div class="wrap-login100-form-btn">
                            <div class="login100-form-bgbtn"></div>
                            <a class="login100-form-btn" href="{{ url('cms/library/admin/login') }}">
                    ...
                    <div class="container-login100-form-btn  mt-3">
                        <div class="wrap-login100-form-btn">
                            <div class="login100-form-bgbtn"></div>
                            <a class="login100-form-btn" href="{{ url('cms/library/author/login') }}">
